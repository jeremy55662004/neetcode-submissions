...
public:
    int largestRectangleArea(vector<int>& heights) {
        // Append a '0' sentinel value to ensure that even if the input 
        // is strictly increasing, all bars are popped and their areas 
        // are calculated when the loop reaches this final element.
        heights.push_back(0);
        stack<int> st;
        int maxArea = 0;
